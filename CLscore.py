...
parse.add_argument('-igl',type=str,required=True,help='GeneLocation.pickle which generate by RNAlamp_matrix.py')
parse.add_argument('-icm',type=str,required=True,help='CoordinateMatrix.pickle which generate by RNAlamp_matrix.py')
parse.add_argument('-igc',type=str,required=True,help='GeneCoLocation.pickle which generate by RNAlamp_matrix.py')
parse.add_argument('-s',type=str,required=True,help='save path, CLscore result will be saved as a tsv file')
